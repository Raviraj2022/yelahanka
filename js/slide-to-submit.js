  ...
  .draggable({
    ...
    stop: function () {
      ...
      if ($(this).parent().width() / 2 < $(this).position().left + 100) {
        ...
        https: location.href =
          "https://api.whatsapp.com/send?phone=917090000779&text=Hi%2C%20I%20am%20Interested%20for%20Pre-Launch%20at%20Noida.%20Please%20send%20Offer%20%26%20Price%20Information.";
